...
return [
	...
	*/
	...
	'slug' => 'sanatorium/pricingexchangecnb',
	...
	*/
	...
	'description' => 'Shop pricing  exchange service  CNB',
	...
	*/
	...
	'providers' => [
		'Sanatorium\Pricingexchangecnb\Providers\CNBServiceProvider'
	],
	...
	*/
	...
	{
		Route::get('/sanatorium/pricingexchangecnb/exchange/' , ['as' => 'admin.sanatorium.pricingexchangecnb.exchange', 'uses' => 'Sanatorium\Pricingexchangecnb\Controllers\Services\CNBExchangesController@exchange']);
		Route::get('/sanatorium/pricingexchangecnb/exchange/history/' , ['as' => 'admin.sanatorium.pricingexchangecnb.exchange.history', 'uses' => 'Sanatorium\Pricingexchangecnb\Controllers\Services\CNBExchangesController@history']);

		Route::group([
				'prefix'    => admin_uri().'/pricingexchangecnb',
				'namespace' => 'Sanatorium\Pricingexchangecnb\Controllers\Services',
			], function()
			{
				Route::get('/' , ['as' => 'admin.sanatorium.pricingexchangecnb.all', 'uses' => 'CNBExchangesController@index']);	
			});
	},
	...
	'menus' => [
		...
		'admin-sanatorium-pricing' => [
			...
			[
				...
				'uri'   => 'pricingexchangecnb',
				'regex' => '/:admin\/pricingexchangecnb/i',
			],
